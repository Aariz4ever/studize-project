                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text(DateFormat.jm().format(task!.timeStart),style: GoogleFonts.poppins(color: Colors.grey[300]),),
                              Text('to',style: GoogleFonts.poppins(color: Colors.grey[300]),),
                              Text(DateFormat.jm().format(task!.timeEnd),style: GoogleFonts.poppins(color: Colors.grey[300]),),
                            ],
                          ),
                          const SizedBox(
                            width: 10,
